...
---------------------------------------------------------------------------------------
|   0 | SELECT STATEMENT                 |               |  1501 |   162K|   336   (0)|
|   1 |  TABLE ACCESS BY INDEX ROWID     | ORDERS        |  1501 |   162K|   336   (0)|
|   2 |   BITMAP CONVERSION TO ROWIDS    |               |       |       |            |
|   3 |    BITMAP OR                     |               |       |       |            |
|   4 |     BITMAP CONVERSION FROM ROWIDS|               |       |       |            |
|*  5 |      INDEX RANGE SCAN            | O_CLERK_IX    |       |       |     8   (0)|
|   6 |     BITMAP CONVERSION FROM ROWIDS|               |       |       |            |
|*  7 |      INDEX RANGE SCAN            | O_ORDERKEY_IX |       |       |     3   (0)|
---------------------------------------------------------------------------------------
...
\end{lstlisting}
Zusatz: Zwecks besserer Darstellung wurden die Zeitangaben herausgenommen.
Diese betrugen zwischen 00:00:01 und 00:00:05. \newline
\textbf{Reflexion} \newline
...
| Id  | Operation                        | Name          | Rows  | Bytes | Cost (%CPU)|
---------------------------------------------------------------------------------------
|   0 | SELECT STATEMENT                 |               |     6 |   666 |    27  (12)|
|   1 |  TABLE ACCESS BY INDEX ROWID     | ORDERS        |     6 |   666 |    27  (12)|
|   2 |   BITMAP CONVERSION TO ROWIDS    |               |       |       |            |
|   3 |    BITMAP AND                    |               |       |       |            |
|   4 |     BITMAP CONVERSION FROM ROWIDS|               |       |       |            |
|   5 |      SORT ORDER BY               |               |       |       |            |
|*  6 |       INDEX RANGE SCAN           | O_ORDERKEY_IX |  2780 |       |     9   (0)|
|   7 |     BITMAP CONVERSION FROM ROWIDS|               |       |       |            |
|   8 |      SORT ORDER BY               |               |       |       |            |
|*  9 |       INDEX RANGE SCAN           | O_CLERK_IX    |  2780 |       |    14   (0)|
---------------------------------------------------------------------------------------
...
\end{lstlisting}
Zusatz: Auf Zeitangaben wurde zwecks Darstellung verzichtet. \newline
\textbf{Reflexion} \newline
